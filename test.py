...
# Set up the screen and other configurations
wn = turtle.Screen()
...
# Function to create a border for the players
def create_border(turtle_object, x, y):
    turtle_object.penup()
